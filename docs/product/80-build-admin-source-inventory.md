...
P8.1 - Build Admin Source Inventory

## Purpose

Build the operator inventory view for audited TOEIC source rows, including the 73-row manifest and blocked-source state.
...
`feat(p8.1): build admin source inventory`
