...
P8.6 - Build Content Publish Queue

## Purpose

Build the controlled publish queue so only reviewed, validated content reaches learner APIs.
...
rg -n "ContentPublishQueue|publish_queue|prepublish" frontend/src frontend/tests docs/product
```

## Commit

`feat(p8.6): build content publish queue`
