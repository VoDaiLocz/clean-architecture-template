...
var tests = new List<(string Name, Action Run)>
{
    ...
    ("Engine supports Part 2 only", ToeicPart2EngineTests.EngineSupportsPart2Only),
    ("Missing MediaAssetId throws (Part 2)", ToeicPart2EngineTests.MissingMediaAssetIdThrows),
    ("Invalid options throws (Part 2)", ToeicPart2EngineTests.InvalidOptionsThrows),
    ("Playable item hides answer and prompt", ToeicPart2EngineTests.PlayableItemHidesAnswerAndPrompt),
    ("Review item includes answer and prompt", ToeicPart2EngineTests.ReviewItemIncludesAnswerAndPrompt),
    ("Engine supports Part 3 only", ToeicPart3EngineTests.EngineSupportsPart3Only),
    ("Missing GroupId throws (Part 3)", ToeicPart3EngineTests.MissingGroupIdThrows),
    ("Invalid options throws (Part 3)", ToeicPart3EngineTests.InvalidOptionsThrows),
    ("Playable item has prompt and GroupRef (Part 3)", ToeicPart3EngineTests.PlayableItemHasPromptAndGroupRef),
    ("Review item has prompt and answer (Part 3)", ToeicPart3EngineTests.ReviewItemHasPromptAndAnswer),
    ("Engine supports Part 4 only", ToeicPart4EngineTests.EngineSupportsPart4Only),
    ("Missing GroupId throws (Part 4)", ToeicPart4EngineTests.MissingGroupIdThrows),
    ("Invalid options throws (Part 4)", ToeicPart4EngineTests.InvalidOptionsThrows),
    ("Playable item has prompt and GroupRef (Part 4)", ToeicPart4EngineTests.PlayableItemHasPromptAndGroupRef),
    ("Review item has prompt and answer (Part 4)", ToeicPart4EngineTests.ReviewItemHasPromptAndAnswer),
    ("Engine supports Part 5 only", ToeicPart5EngineTests.EngineSupportsPart5Only),
    ("Missing prompt throws (Part 5)", ToeicPart5EngineTests.MissingPromptThrows),
    ("Invalid options throws (Part 5)", ToeicPart5EngineTests.InvalidOptionsThrows),
    ("Playable item hides answer and sets payload (Part 5)", ToeicPart5EngineTests.PlayableItemHidesAnswerAndSetsPayload),
    ("Review item includes answer (Part 5)", ToeicPart5EngineTests.ReviewItemIncludesAnswer),
    ("Engine supports Part 6 only", ToeicPart6EngineTests.EngineSupportsPart6Only),
    ("Missing PassageId throws (Part 6)", ToeicPart6EngineTests.MissingPassageIdThrows),
    ("Invalid options throws (Part 6)", ToeicPart6EngineTests.InvalidOptionsThrows),
    ("Playable item sets payload and PassageRefs (Part 6)", ToeicPart6EngineTests.PlayableItemSetsPayloadAndPassageRefs),
    ("Review item includes answer and PassageRefs (Part 6)", ToeicPart6EngineTests.ReviewItemIncludesAnswerAndPassageRefs),
    ("Engine supports Part 7 only", ToeicPart7EngineTests.EngineSupportsPart7Only),
    ("Missing PassageId throws (Part 7)", ToeicPart7EngineTests.MissingPassageIdThrows),
    ("Invalid options throws (Part 7)", ToeicPart7EngineTests.InvalidOptionsThrows),
    ("Playable item sets payload and PassageRefs (Part 7)", ToeicPart7EngineTests.PlayableItemSetsPayloadAndPassageRefs),
    ("Review item includes answer and PassageRefs (Part 7)", ToeicPart7EngineTests.ReviewItemIncludesAnswerAndPassageRefs),
    ...
    ("ListeningTest: Starts session with correct assigned questions", Application.UnitTest.ListeningTestSessionTests.StartsSessionWithCorrectAssignedQuestions),
    ...
    ("FullTest: Starts session with correct assigned questions", Application.UnitTest.FullTestSessionTests.StartsSessionWithCorrectAssignedQuestions),
